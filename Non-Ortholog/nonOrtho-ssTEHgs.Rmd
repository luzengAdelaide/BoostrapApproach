---
title: "Non-ortholog Genes with ssTE"
...
Load the data
```{r loadData}
tpmFile <- file.path(".", "hg_3RTENonortholog.txt")
...
save(bootLINEHgAll, file = "bootRecentLINEHgAll.RData")
```
...
save(bootSINEHgAll, file = "bootRecentSINEHgAll.RData")
```
...
save(bootERVHgAll, file = "bootRecentERVHgAll.RData")
```
...
```{r}
save.image("SteveBootstrapnonOrtho-ssTE.RData")
```
